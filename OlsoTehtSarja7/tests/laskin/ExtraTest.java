...
public class ExtraTest extends AbstractParent {
    ...
    public void testNeliojuuri2() {
        laskin.neliojuuri(2);
		// Tähän tuloksen tarkastus assertXXX(), odotetun tuloksen tulee olla (int)Math.sqrt(2)
        assertEquals(1.414, laskin.annaTulos(), DELTA, "Luvun 2 neliojuuri on väärin");
    }
    ...
    public void testNeliojuuriNegat() {
    	...
    	assertEquals("Negatiivisesta ei voi ottaa neliöjuurta", poikkeus.getMessage(), "Väärä virheilmoitus");
    }
}